...
void Pairing_tau_had_6TeV(const char *inputSigFile,
...
*/
    ...
    TLatex title1(35, 17.6, "#bf{#font[72]{Muon Collider Simulation (Delphes)}}");
    title1.SetTextSize(0.04); 
    TLatex latexup1(105, 11, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{6 TeV}");
    latexup1.SetTextSize(0.025); 
    TLatex latexdown1(105, 10, "#font[52]{L} #font[42]{=} #font[52]{4 ab^{-1}}");
    ...
    TLatex latexSigstrength1(105, 9, latex_1);
    latexSigstrength1.SetTextSize(0.025);
    latexSigstrength1.Draw("same");
    latexup1.Draw("same");
    latexdown1.Draw("same");
    title1.Draw("same");
    totalcanvas -> SaveAs("JetPairs1_sig+bkg_tau_had_6TeV.png");
    ...
    TLatex title2(35, 18.15, "#bf{#font[72]{Muon Collider Simulation (Delphes)}}");
    title2.SetTextSize(0.04); 
    TLatex latexup2(10, 11, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{6 TeV}");
    latexup2.SetTextSize(0.025); 
    TLatex latexdown2(10, 9.5, "#font[52]{L} #font[42]{=} #font[52]{4 ab^{-1}}");
    ...
    TLatex latexSigstrength2(10, 8, latex_2);
    latexSigstrength2.SetTextSize(0.025);
    latexSigstrength2.Draw("same");
    latexup2.Draw("same");
    latexdown2.Draw("same");
    title2.Draw("same");
    totalcanvas -> SaveAs("JetPairs2_sig+bkg_tau_had_6TeV.png");
    ...
    TLatex latexUp4(120, 152, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{6 TeV}");
    TLatex latexDown4(120, 142, "#font[52]{L} #font[42]{=} #font[52]{4 ab^{-1}}");
    ...
    title4.Draw("same");
    totalcanvas -> SaveAs("JetPair2D_sig+bkgBDT_tau_had_6TeV.png");
