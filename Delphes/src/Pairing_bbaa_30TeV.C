...
void Pairing_bbaa_30TeV(const char *inputSigFile,
    ...
    Double_t weight1 = 0.00116;
    Double_t weight2 = 0.00592;
    Double_t weight3 = 0.00345;
    ...
    legend -> Draw();
    TLatex title1(117, 11.9, "#bf{#font[72]{Muon Collider Simulation (Delphes)}}");
    title1.SetTextSize(0.04); 
    TLatex latexup1(111, 10, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{30 TeV}");
    latexup1.SetTextSize(0.025); 
    TLatex latexdown1(111, 9, "#font[52]{L} #font[42]{=} #font[52]{10 ab^{-1}}");
    latexdown1.SetTextSize(0.025);
    string init1("#font[52]{#frac{S}{#sqrt{S+B}}} #font[42]{=} #font[52]{");
    string add1 = to_string(SigStrength);
    string end1("}");
    //string end1("} #font[52]{(90#leqm_{H}#leq130)}");
    init1 = init1 + add1.substr(0, 5) + end1;
    const char * latex_1 = init1.c_str();
    TLatex latexSigstrength1(111, 8, latex_1);
    latexSigstrength1.SetTextSize(0.025);
    latexSigstrength1.Draw("same");
    latexup1.Draw("same");
    latexdown1.Draw("same");
    title1.Draw("same");
    totalcanvas -> SaveAs("JetPairs1_sig+bkg_bbaa_30TeV.png");
    ...
    legend2 -> Draw();
    TLatex title2(35, 5.5, "#bf{#font[72]{Muon Collider Simulation (Delphes)}}");
    title2.SetTextSize(0.04); 
    TLatex latexup2(10, 4.5, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{30 TeV}");
    latexup2.SetTextSize(0.025); 
    TLatex latexdown2(10, 4, "#font[52]{L} #font[42]{=} #font[52]{10 ab^{-1}}");
    latexdown2.SetTextSize(0.025);
    string init2("#font[52]{#frac{S}{#sqrt{S+B}}} #font[42]{=} #font[52]{");
    string add2 = to_string(SigStrength);
    string end2("}");
    //string end2("} #font[52]{(90#leqm_{H}#leq130)}");
    ...
    title2.Draw("same");
    totalcanvas -> SaveAs("JetPairs2_sig+bkg_bbaa_30TeV.png");
    ...
    TLatex latexUp4(112, 45, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{30 TeV}");
    ...
    string end3("}");
    //string end3("} #font[52]{(90#leqm_{b#bar{b}}#leq130)}");
    ...
    title4.Draw("same");
    totalcanvas -> SaveAs("JetPair2D_sig+bkgBDT_bbaa_30TeV.png");
