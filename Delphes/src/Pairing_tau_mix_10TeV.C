...
void Pairing_tau_mix_10TeV(const char *inputSigFile,
...
*/
    ...
    legend -> Draw();
    TLatex title1(35, 62, "#bf{#font[72]{Muon Collider Simulation (Delphes)}}");
    title1.SetTextSize(0.04); 
    TLatex latexup1(105, 38, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{10 TeV}");
    latexup1.SetTextSize(0.025); 
    TLatex latexdown1(105, 32, "#font[52]{L} #font[42]{=} #font[52]{10 ab^{-1}}");
    ...
    TLatex latexSigstrength1(105, 26, latex_1);
    latexSigstrength1.SetTextSize(0.025);
    latexSigstrength1.Draw("same");
    latexup1.Draw("same");
    latexdown1.Draw("same");
    title1.Draw("same");
    totalcanvas -> SaveAs("JetPairs1_sig+bkg_tau_mix_10TeV.png");
    ...
    legend2 -> Draw();
    TLatex title2(35, 64.3, "#bf{#font[72]{Muon Collider Simulation (Delphes)}}");
    title2.SetTextSize(0.04); 
    TLatex latexup2(10, 40, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{10 TeV}");
    ...
    title2.Draw("same");
    totalcanvas -> SaveAs("JetPairs2_sig+bkg_tau_mix_10TeV.png");
    ...
    TLatex latexUp4(120, 155, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{10 TeV}");
    ...
    title4.Draw("same");
    totalcanvas -> SaveAs("JetPair2D_sig+bkgBDT_tau_mix_10TeV.png");
