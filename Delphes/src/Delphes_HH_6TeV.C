...
void trainBDT(const char *BDToutputFileName) {
    ...
    TFile* dataFile = new TFile("~/Delphes/delphes_dhiggs_sig+bkg_pairmass_6TeV.root");
...
void applyBDT(const char *BDTApplyOutputFileName) {
    ...
    Double_t weight1 = 0.01769;
    Double_t weight2 = 0.037048;
    Double_t weight3 = 0.119557;
    Double_t weight4 = 0.17541;
    Double_t weight5 = 1.271834;
...
*/
    ...
    TLatex latexUp1(95, 9e3, "\#font[52]{#sqrt{s}} = 6 TeV}");
    TLatex latexDown1(98, 5e3, "#font[52]{L} #font[42]{=} #font[52]{4 ab^{-1}}");
    ...
    title1.Draw("same");
    totalcanvas -> SaveAs("JetPairs1_sig+bkgBDT_6TeV.png");
    ...
    title2.Draw("same");
    totalcanvas -> SaveAs("JetPairs2_sig+bkgBDT_6TeV.png");
    ...
    JetPairsBDT -> SetMinimum(1);
    //JetPairsBDT -> GetYaxis() -> SetTitle("events");
    TLatex title3(700, 2e4, "#bf{#font[72]{Muon Collider Simulation (Delphes)}}");
    title3.SetTextSize(0.04);
    TLatex latexUp3(850, 5e3, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{6 TeV}");
    TLatex latexDown3(850, 2e3, "#font[52]{L} #font[42]{=} #font[52]{4 ab^{-1}}");
    ...
    TLatex latexSigStrength2(850, 1e3, latex2);
    ...
    title3.Draw("same");
    totalcanvas -> SaveAs("JetPairs_sig+bkgBDT_6TeV.png");
    ...
    TLatex latexUp4(57, 151, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{6 TeV}");
    TLatex latexDown4(57, 146, "#font[52]{L} #font[42]{=} #font[52]{4 ab^{-1}}");
    ...
    title4.Draw("same");
    totalcanvas -> SaveAs("JetPair2D_sig+bkgBDT_6TeV.png");
//Stack histo for BDT
    ...
    histBdt_bkg4 -> SetFillColor(kTeal+1);
    ...
    */
    ...
    titleBdt.Draw("same");
    totalcanvas -> SaveAs("BDT_sig+bkgBDT_6TeV.png");
...
void Delphes_HH_6TeV(const char *inputSigFile,
...
/*
    Double_t weight1 = 0.00197*8*100000/97500;
    Double_t weight2 = 0.00096*8*100000/96387;
    Double_t weight3 = 0.0057*8*100000/91090;
    Double_t weight4 = 0.129*8*100000/97187;
    Double_t weight5 = 0.155*8*100000/97095;
*/
    ...
    TLatex title1(75, 795, "#bf{#font[72]{Muon Collider Simulation (Delphes)}}");
    title1.SetTextSize(0.04); 
    TLatex latexup1(110, 500, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{6 TeV}");
    latexup1.SetTextSize(0.025); 
    TLatex latexdown1(110, 450, "#font[52]{L} #font[42]{=} #font[52]{4 ab^{-1}}");
    ...
    TLatex latexSigstrength1(110, 400, latex_1);
    latexSigstrength1.SetTextSize(0.025);
    latexSigstrength1.Draw("same");
    latexup1.Draw("same");
    latexdown1.Draw("same");
    title1.Draw("same");
    totalcanvas -> SaveAs("JetPairs1_sig+bkg_6TeV.png");
    ...
    TLatex title2(75, 790, "#bf{#font[72]{Muon Collider Simulation (Delphes)}}");
    title2.SetTextSize(0.04); 
    TLatex latexup2(110, 475, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{6 TeV}");
    latexup2.SetTextSize(0.025); 
    TLatex latexdown2(110, 400, "#font[52]{L} #font[42]{=} #font[52]{4 ab^{-1}}");
    ...
    TLatex latexSigstrength2(110, 325, latex_2);
    latexSigstrength2.SetTextSize(0.025);
    latexSigstrength2.Draw("same");
    latexup2.Draw("same");
    latexdown2.Draw("same");
    title2.Draw("same");
    totalcanvas -> SaveAs("JetPairs2_sig+bkg_6TeV.png");
    ...
    trainBDT("delphes_dhiggs_sig+bkg_BDT_6TeV.root");
    //apply BDT model
    cout << "Start Boosting Decision Trees application..." << endl;
    applyBDT("delphes_dhiggs_sig+bkg_BDTapply_6TeV.root");
