...
void Pairing_tau_mix_3TeV(const char *inputSigFile,
...
*/
    ...
    legend -> Draw();
    TLatex title1(35, 3.25, "#bf{#font[72]{Muon Collider Simulation (Delphes)}}");
    title1.SetTextSize(0.04); 
    TLatex latexup1(110, 2, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{3 TeV}");
    latexup1.SetTextSize(0.025); 
    TLatex latexdown1(110, 1.75, "#font[52]{L} #font[42]{=} #font[52]{1 ab^{-1}}");
    ...
    TLatex latexSigstrength1(110, 1.5, latex_1);
    latexSigstrength1.SetTextSize(0.025);
    latexSigstrength1.Draw("same");
    latexup1.Draw("same");
    latexdown1.Draw("same");
    title1.Draw("same");
    totalcanvas -> SaveAs("JetPairs1_sig+bkg_tau_mix_3TeV.png");
    ...
    legend2 -> Draw();
    TLatex title2(35, 3.5, "#bf{#font[72]{Muon Collider Simulation (Delphes)}}");
    title2.SetTextSize(0.04); 
    TLatex latexup2(10, 2.2, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{3 TeV}");
    latexup2.SetTextSize(0.025); 
    TLatex latexdown2(10, 1.9, "#font[52]{L} #font[42]{=} #font[52]{1 ab^{-1}}");
    ...
    TLatex latexSigstrength2(10, 1.6, latex_2);
    latexSigstrength2.SetTextSize(0.025);
    latexSigstrength2.Draw("same");
    latexup2.Draw("same");
    latexdown2.Draw("same");
    title2.Draw("same");
    totalcanvas -> SaveAs("JetPairs2_sig+bkg_tau_mix_3TeV.png");
    ...
    TLatex latexUp4(120, 155, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{3 TeV}");
    TLatex latexDown4(120, 145, "#font[52]{L} #font[42]{=} #font[52]{1 ab^{-1}}");
    ...
    title4.Draw("same");
    totalcanvas -> SaveAs("JetPair2D_sig+bkgBDT_tau_mix_3TeV.png");
