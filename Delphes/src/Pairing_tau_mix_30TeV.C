...
void Pairing_tau_mix_30TeV(const char *inputSigFile,
...
*/
    ...
    legend -> Draw();
    TLatex title1(35, 65, "#bf{#font[72]{Muon Collider Simulation (Delphes)}}");
    title1.SetTextSize(0.04); 
    TLatex latexup1(100, 40, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{30 TeV}");
    latexup1.SetTextSize(0.025); 
    TLatex latexdown1(100, 35, "#font[52]{L} #font[42]{=} #font[52]{10 ab^{-1}}");
    ...
    TLatex latexSigstrength1(100, 30, latex_1);
    latexSigstrength1.SetTextSize(0.025);
    latexSigstrength1.Draw("same");
    latexup1.Draw("same");
    latexdown1.Draw("same");
    title1.Draw("same");
    totalcanvas -> SaveAs("JetPairs1_sig+bkg_tau_mix_30TeV.png");
    ...
    legend2 -> Draw();
    TLatex title2(35, 73, "#bf{#font[72]{Muon Collider Simulation (Delphes)}}");
    title2.SetTextSize(0.04); 
    TLatex latexup2(10, 44, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{30 TeV}");
    latexup2.SetTextSize(0.025); 
    TLatex latexdown2(10, 40, "#font[52]{L} #font[42]{=} #font[52]{10 ab^{-1}}");
    ...
    TLatex latexSigstrength2(10, 36, latex_2);
    latexSigstrength2.SetTextSize(0.025);
    latexSigstrength2.Draw("same");
    latexup2.Draw("same");
    latexdown2.Draw("same");
    title2.Draw("same");
    totalcanvas -> SaveAs("JetPairs2_sig+bkg_tau_mix_30TeV.png");
    ...
    TLatex latexUp4(120, 155, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{30 TeV}");
    TLatex latexDown4(120, 145, "#font[52]{L} #font[42]{=} #font[52]{10 ab^{-1}}");
    ...
    title4.Draw("same");
    totalcanvas -> SaveAs("JetPair2D_sig+bkgBDT_tau_mix_30TeV.png");
