...
void Pairing_tau_had_10TeV(const char *inputSigFile,
...
*/
    ...
    Double_t weight1 = 0.012566257;
    Double_t weight2 = 0.052727636;
    Double_t weight3 = 0.037206942;
    Double_t weight4 = 0.030304243;
    ...
    TLatex title1(35, 52.5, "#bf{#font[72]{Muon Collider Simulation (Delphes)}}");
    title1.SetTextSize(0.04); 
    TLatex latexup1(105, 30, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{10 TeV}");
    latexup1.SetTextSize(0.025); 
    TLatex latexdown1(105, 26, "#font[52]{L} #font[42]{=} #font[52]{10 ab^{-1}}");
    ...
    TLatex latexSigstrength1(105, 22, latex_1);
    latexSigstrength1.SetTextSize(0.025);
    latexSigstrength1.Draw("same");
    latexup1.Draw("same");
    latexdown1.Draw("same");
    title1.Draw("same");
    totalcanvas -> SaveAs("JetPairs1_sig+bkg_tau_had_10TeV.png");
    ...
    TLatex title2(35, 54.5, "#bf{#font[72]{Muon Collider Simulation (Delphes)}}");
    title2.SetTextSize(0.04); 
    TLatex latexup2(10, 32, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{10 TeV}");
    latexup2.SetTextSize(0.025); 
    TLatex latexdown2(10, 28, "#font[52]{L} #font[42]{=} #font[52]{10 ab^{-1}}");
    ...
    TLatex latexSigstrength2(10, 24, latex_2);
    latexSigstrength2.SetTextSize(0.025);
    latexSigstrength2.Draw("same");
    latexup2.Draw("same");
    latexdown2.Draw("same");
    title2.Draw("same");
    totalcanvas -> SaveAs("JetPairs2_sig+bkg_tau_had_10TeV.png");
    ...
    TLatex latexUp4(120, 152, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{10 TeV}");
    ...
    title4.Draw("same");
    totalcanvas -> SaveAs("JetPair2D_sig+bkgBDT_tau_had_10TeV.png");
