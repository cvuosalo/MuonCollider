...
void Pairing_tau_had_3TeV(const char *inputSigFile,
...
*/
    ...
    Double_t weight1 = 0.0003255;
    Double_t weight2 = 0.001009137;
    Double_t weight3 = 0.001546;
    Double_t weight4 = 0.0007965;
    ...
    TLatex title1(35, 2.9, "#bf{#font[72]{Muon Collider Simulation (Delphes)}}");
    title1.SetTextSize(0.04); 
    TLatex latexup1(105, 1.8, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{3 TeV}");
    latexup1.SetTextSize(0.025); 
    TLatex latexdown1(105, 1.6, "#font[52]{L} #font[42]{=} #font[52]{1 ab^{-1}}");
    ...
    TLatex latexSigstrength1(105, 1.4, latex_1);
    latexSigstrength1.SetTextSize(0.025);
    latexSigstrength1.Draw("same");
    latexup1.Draw("same");
    latexdown1.Draw("same");
    title1.Draw("same");
    totalcanvas -> SaveAs("JetPairs1_sig+bkg_tau_had_3TeV.png");

    JetPair2 -> Draw("HIST");
    JetPair2 -> SetMaximum(3.5);
    ...
    TLatex title2(35, 3.7, "#bf{#font[72]{Muon Collider Simulation (Delphes)}}");
    title2.SetTextSize(0.04); 
    TLatex latexup2(10, 2.3, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{3 TeV}");
    latexup2.SetTextSize(0.025); 
    TLatex latexdown2(10, 2, "#font[52]{L} #font[42]{=} #font[52]{1 ab^{-1}}");
    ...
    TLatex latexSigstrength2(10, 1.7, latex_2);
    latexSigstrength2.SetTextSize(0.025);
    latexSigstrength2.Draw("same");
    latexup2.Draw("same");
    latexdown2.Draw("same");
    title2.Draw("same");
    totalcanvas -> SaveAs("JetPairs2_sig+bkg_tau_had_3TeV.png");
    ...
    TLatex latexUp4(120, 152, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{3 TeV}");
    TLatex latexDown4(120, 142, "#font[52]{L} #font[42]{=} #font[52]{1 ab^{-1}}");
    ...
    title4.Draw("same");
    totalcanvas -> SaveAs("JetPair2D_sig+bkgBDT_tau_had_3TeV.png");
