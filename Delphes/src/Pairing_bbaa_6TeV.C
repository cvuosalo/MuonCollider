...
/*
	    if (AKTjetpair2Mass > 130 or AKTjetpair2Mass < 90) {
		continue;
	    }
*/
...
void Pairing_bbaa_6TeV(const char *inputSigFile,
    ...
    Double_t weight1 = 0.000123;
    Double_t weight2 = 0.000681;
    Double_t weight3 = 0.000436;
    ...
    legend -> Draw();
    TLatex title1(117, 3.22, "#bf{#font[72]{Muon Collider Simulation (Delphes)}}");
    title1.SetTextSize(0.04); 
    TLatex latexup1(111, 2.3, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{6 TeV}");
    latexup1.SetTextSize(0.025); 
    TLatex latexdown1(111, 2, "#font[52]{L} #font[42]{=} #font[52]{4 ab^{-1}}");
    ...
    TLatex latexSigstrength1(111, 1.7, latex_1);
    latexSigstrength1.SetTextSize(0.025);
    latexSigstrength1.Draw("same");
    latexup1.Draw("same");
    latexdown1.Draw("same");
    title1.Draw("same");
    totalcanvas -> SaveAs("JetPairs1_sig+bkg_bbaa_6TeV.png");
    ...
    legend2 -> Draw();
    TLatex title2(35, 1.55, "#bf{#font[72]{Muon Collider Simulation (Delphes)}}");
    title2.SetTextSize(0.04); 
    TLatex latexup2(10, 1.15, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{6 TeV}");
    latexup2.SetTextSize(0.025); 
    TLatex latexdown2(10, 1, "#font[52]{L} #font[42]{=} #font[52]{4 ab^{-1}}");
    ...
    TLatex latexSigstrength2(10, 0.85, latex_2);
    latexSigstrength2.SetTextSize(0.025);
    latexSigstrength2.Draw("same");
    latexup2.Draw("same");
    latexdown2.Draw("same");
    title2.Draw("same");
    totalcanvas -> SaveAs("JetPairs2_sig+bkg_bbaa_6TeV.png");
    ...
    TLatex latexUp4(112, 45, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{6 TeV}");
    TLatex latexDown4(112, 30, "#font[52]{L} #font[42]{=} #font[52]{4 ab^{-1}}");
    ...
    title4.Draw("same");
    totalcanvas -> SaveAs("JetPair2D_sig+bkgBDT_bbaa_6TeV.png");
