...
void Pairing_bbaa_10TeV(const char *inputSigFile,
    ...
    Double_t weight1 = 0.000502;
    Double_t weight2 = 0.00291;
    Double_t weight3 = 0.00171;
    ...
    legend -> Draw();
    TLatex title1(117, 9.9, "#bf{#font[72]{Muon Collider Simulation (Delphes)}}");
    title1.SetTextSize(0.04); 
    TLatex latexup1(111, 8, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{10 TeV}");
    latexup1.SetTextSize(0.025); 
    TLatex latexdown1(111, 7, "#font[52]{L} #font[42]{=} #font[52]{10 ab^{-1}}");
    ...
    title1.Draw("same");
    totalcanvas -> SaveAs("JetPairs1_sig+bkg_bbaa_10TeV.png");
    ...
    legend2 -> Draw();
    TLatex title2(35, 4.85, "#bf{#font[72]{Muon Collider Simulation (Delphes)}}");
    title2.SetTextSize(0.04); 
    TLatex latexup2(10, 4.5, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{10 TeV}");
    ...
    title2.Draw("same");
    totalcanvas -> SaveAs("JetPairs2_sig+bkg_bbaa_10TeV.png");

    totalcanvas -> SetCanvasSize(1300,1200);
    totalcanvas -> SetLogy(0);
    JetPair2DBDT -> Draw("SCAT=1");
    ...
    TLatex latexUp4(112, 45, "#font[52]{#sqrt{s}} #font[42]{=} #font[52]{10 TeV}");
    ...
    title4.Draw("same");
    totalcanvas -> SaveAs("JetPair2D_sig+bkgBDT_bbaa_10TeV.png");
