...
void UniqueObjectFinder::Init()
{
  ...
  fUseUniqueID = GetBool("UseUniqueID", true);
...
void UniqueObjectFinder::Process()
{
  ...
  //int counter = 0;
  //cout << "start loop for unique objeect finder" << endl;
  ...
  //cout << "not crash in " << counter << "th loop of inputmap" << endl;
  //counter++;
  }
  //cout << "Finish unique object finder process." << endl;
}
