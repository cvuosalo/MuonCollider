...
module Merger BIBEFlowMerger {
    ...
    add InputArray BIBNeutralHadrons/eflowNeutralHadrons
    # add InputArray MuonMomentumSmearing/muons
    set OutputArray eflow
}
...
module TreeWriter TreeWriter {
    ...
    add Branch HCal/eflowNeutralHadrons EFlowNeutralHadrons Track
    add Branch BIBHCal/eflowNeutralHadrons BIBHCalEFlowNeutralHadrons Track
    add Branch BIBNeutralHadrons/eflowNeutralHadrons BIBEFlowNeutralHadrons Track
    add Branch ECal/eflowPhotons EFlowPhoton Track 
    add Branch BIBECal/eflowPhotons BIBEFlowPhoton Track
    add Branch ECal/eflowTracks EFlowTracks Track
    add Branch BIBECal/eflowTracks BIBEFlowTracks Track
