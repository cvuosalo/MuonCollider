...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const deque<double>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("deque<double>", -2, "deque", 766,
...
"external",
"/cvmfs/sft.cern.ch/lcg/releases/ROOT/6.24.06-3455f/x86_64-centos7-gcc11-opt/include/",
"/nfs_scratch/hjia38/runMG_job/MG5_aMC_v3_3_1/Delphes/",
0
    };
