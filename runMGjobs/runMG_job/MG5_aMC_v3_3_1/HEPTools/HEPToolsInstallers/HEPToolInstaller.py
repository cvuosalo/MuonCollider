               ...
               {'install_mode':'Default',
                ...
                'MG5_version_constraints' : [
                    ...
                    ( lambda MG5version: PY3,
                       ['online','http://madgraph.phys.ucl.ac.be/Downloads/ma5_py3/MA5_PY3_164.tar.gz']),
...
#       raise Exception('MadAnalysis5 still request Python2')
    ...
    if sys.version_info[0]!=2:
       ...
       subprocess.call('mv ma5_py3 madanalysis5', shell=True, cwd=_HepTools['madanalysis5']['install_path'])
